...
$page_title = " Subtraction";
include(SHARED_PATH . '/header.php');
$user_level = $_SESSION['sub_level'];
...
if (is_request_post()) {
    ...
    $_SESSION['sub_level'] = $user_level;

    $update = update_user($db, $_SESSION['user_id'], 'sub_level', $user_level);
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 text-primary">Subtraction</h1>
    ...
    <div class="row">
            ...
            <div class="col-md-3">
                <h4>You are at subtraction level: <span class="sign"><?php echo $_SESSION['sub_level'];?></span></h4>
            </div>
            ...
            <div class="row form-group">
                <?php 
                    ...
                    switch ($user_level) {
                        case $user_level == 3:
                        case $user_level == 4:
                        case $user_level == 5: $multiplier1 = 100; $multiplier2 = 50;
                            break;
                    } 
                    $num1 = rand(0, $multiplier1 * $user_level);
                    $num2 = rand(0, $multiplier2 * $user_level);

                    $num1 = $num1 > $num2 ? $num1: $num2 + rand(0, $multiplier2);
                ?>
