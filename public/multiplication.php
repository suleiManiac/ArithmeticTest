...
$user_level = $_SESSION['mult_level'];
if (is_request_post()) {
    ...
    $_SESSION['mult_level'] = $user_level;

    $update = update_user($db, $_SESSION['user_id'], 'mult_level', $user_level);
...
?>
<?php include(SHARED_PATH . '/sidebar.php');  $multiplier = 5;?>

<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 text-primary">Multiplication</h1>
    ...
    <div class="row">
            ...
            <div class="col-md-3">
                <h4>You are at multipication level: <span class="sign"><?php echo $_SESSION['mult_level'];?></span></h4>
            </div>
        ...
        <?php for ($i = 0; $i < 1 + $user_level; $i++) { ?>
            <div class="row form-group">
                <?php 
                    ...
                    $num1 = rand(0, $multiplier * $user_level);
                    $num2 = rand(0, $multiplier * $user_level);
