...
if (is_request_post()) {
    ...
    $_SESSION['add_level'] = $user_level;

    $update = update_user($db, $_SESSION['user_id'], 'add_level', $user_level);
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
            ...
            <div class="col-md-3">
                <h4>You are at addition level: <span class="sign"><?php echo $_SESSION['add_level'];?></span></h4>
            </div>
